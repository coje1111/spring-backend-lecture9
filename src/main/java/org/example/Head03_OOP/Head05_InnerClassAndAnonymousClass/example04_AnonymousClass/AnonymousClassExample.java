package org.example.Head03_OOP.Head05_InnerClassAndAnonymousClass.example04_AnonymousClass;
...
public class AnonymousClassExample {
    ...
    public static void main(String[] args) {
        ...
        EventListener listener = new EventListener() {
            @Override
            public void onEvent(String eventDate) {
                System.out.println("이벤트 발생:" + eventDate);
            }
        };
