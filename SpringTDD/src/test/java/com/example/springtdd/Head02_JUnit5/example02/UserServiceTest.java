package com.example.springtdd.Head02_JUnit5.example02;
...
class UserServiceTest {
  ...
  void createUser_shouldReturnName() {
    ...
    System.out.println("createUser - shouldReturnName 실행");
  }
  ...
  void createUser_shouldNotReturnNull() {
    ...
    System.out.println("createUser - shouldNotReturnNull 실행");
  }
